...
public class MathUtils {
   ...
   * @param a The first number
   * @param b The second number
   * @param epsilon The epsilon the comparison will use. Think of this as the allowable difference
  ...
  /**
   * Solves the equation <code>0 = ax<sup>2</sup> + bx + c</code> for x and returns the real
   * results.
   *
