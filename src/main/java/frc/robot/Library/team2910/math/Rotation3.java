...
/**
 * This represents a rotation in 3d space through a rotation matrix and its corresponding euler
 * angles
 */
public class Rotation3 {
  ...
  public String toString() {
    ...
    return "Rotation "
        + "- X: "
        + fmt.format(Math.toDegrees(eulerAngles[0]))
        + '\u00b0'
        + ", Y: "
        + fmt.format(Math.toDegrees(eulerAngles[1]))
        + '\u00b0'
        + ", Z: "
        + fmt.format(Math.toDegrees(eulerAngles[2]))
        + '\u00b0';
  }
}
