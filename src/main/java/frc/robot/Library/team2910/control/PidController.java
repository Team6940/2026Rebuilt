...
public class PidController {
  ...
  public double calculate(double current, double dt) {
    ...
    return MathUtils.clamp(
        constants.p * error + constants.i * integral + constants.d * derivative,
        minOutput,
        maxOutput);
  }
  ...
  public void setShouldClearIntegralOnErrorSignChange(
      boolean shouldClearIntegralOnErrorSignChange) {
