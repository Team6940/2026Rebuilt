package frc.robot.Library.team95;
 ...
 *
 * <p>Makes use of {@link BetterSwerveModuleState} to add the angular velocity that is required of
 * the module as an output.
 */
public class BetterSwerveKinematics extends SwerveDriveKinematics {
   ...
   *     attainable max velocity. Use the {@link #desaturateWheelSpeeds(BetterSwerveModuleState[],
